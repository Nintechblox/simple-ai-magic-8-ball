...
# Asking for some fun extras :)
wackymode = input("Do you want it to be extremely wacky? Yes or No only, capital letter first only.  ")
freedommode = input("Do you want the built in options for the answers, or for the AI to make them up? Say Freedom to turn on freedom mode, capital only.   " )

# Determining if to add extra's
if wackymode == "Yes":
    wackysysprompttext = "Please be EXTREMELY WACKY, DO NOT BE NORMAL, MAKE THE PREDICTIONS WACKY!!"
else:
    print("I guess you don't want it to be wacky, OK!")
...
if freedommode == "Freedom":
    ...
    print("I guess you don't want it to make up it's own predictions, OK!")
...
# No if statements to put in wacky and freedom mode, all in one.
